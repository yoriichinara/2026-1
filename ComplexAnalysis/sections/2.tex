...
\demo{Sean \(D: \overline{D} \subset \Omega\) e \(T\) cualquier triángulo contenido en \(D\). De la uniformidad en \(\overline{D}\) \(f\) es continua, luego sigue de \(\blacksquare\) \hyperlink{thm211}{1.1. (\emph{Goursat})},
\[0 = \int_T f_n(z) \ dz \to \int_T f(z) \ dz = 0 \ \Rightarrow \ f \in \ho(\Omega), \text{ $\blacksquare$ \hyperlink{thm251}{5.1. (\emph{Morera})}}.\] 
\vspace{-0.3cm}
}
