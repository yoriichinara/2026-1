...
{%{ \Large QUALI SURVIVAL GUIDE COLLECTION} \\ 
 \LARGE \textbf{\(^{+4}\)Notes of Complex Analysis}} \vspace{0.1in}   \\
 { \today }\\ 
 {\small
...
{\small ** Content based on the course MM413 (Variavél Complexa) taught by Professor Tiago Jardim Fonseca in the semester 2026-I, mainly following \cite{stein}. **\vspace{0.3cm}}%, destinado àqueles que já possuem alguma familiaridade com o assunto, pois não contém demonstrações formais, apenas as ideias por trás delas. Sinceramente, um fã da simplicidade. \\ 
