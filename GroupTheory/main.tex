...
\newtheorem*{note}{\textnormal{\emph{Note. }}}
...
{%{ \Large QUALI SURVIVAL GUIDE COLLECTION} \\ 
 \LARGE \textbf{Notes of Group's Theory}} \vspace{0.1in}   \\
 { \today }\\ 
 {\small
...
{\small ** Content based on the course MM446 (Grupos e Representações) taught by Professor
Plamen Kochloukov in the semester 2026-I, mainly following \cite{stein}. **\vspace{0.3cm}}%, destinado àqueles que já possuem alguma familiaridade com o assunto, pois não contém demonstrações formais, apenas as ideias por trás delas. Sinceramente, um fã da simplicidade. \\ 


%%%%%%%%%%%%%%%%%%%%%%%%% CONTENIDO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\textbf{Notation}} {\small \hfill \text{\rotatebox{45}{\large $\boxdot$}}  Definition \hfill \(\textcolor{gray}{(-)}^{\text{\ding{71}}}\)  Open \hfill  \(\textcolor{gray}{(-)}^{\text{\ding{70}}}\) Closed  \\ 
\- \hspace{0.4cm}{\scriptsize$\square$} \ Lemma \hfill {\large$\square$} Proposition \hfill  {\large $\blacksquare$}  \ Theorem \hfill {\scriptsize $\boxtimes$}  \ Corollary}
%\begin{center}
