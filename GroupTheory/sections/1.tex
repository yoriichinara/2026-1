...
\begin{definition}
    ...
    \[\star \ \  (i_j) =: \id_{_X} \  \leftarrow \text{\emph{Identidad} } \hspace{2cm}\star \ \ (i_1 \ \ i_2) \ \leftarrow \text{\emph{Transposición}}\]
\end{definition}
...
\ejemplo{
   \textcolor{verdeoscuro}{\underline{\textbf{Ejemplo}}} \ \  \(\blacktriangleright \ \) \ \((S_n, \circ) \  \leftarrow\)   \emph{Grupo Simétrico}. \hfill \(\mid \) \hfill  \(\blacktriangleright\) \ \ \((\F, +) : \F\) es cuerpo. \vspace{0.3cm} \\ 
   \(\blacktriangleright \) \ \ \((\Z_n,+) := \{[a] \in \nicefrac{\Z}{\sim} :  a\sim b \ \leftrightharpoons \ a \equiv b \ (\operatorname{mod} n)\}\).  \hfill \(\mid\) \hfill \(\blacktriangleright\) \ \ \((\GL_n(\F), \cdot)\).
}
