...
\begin{definition}
    Sean \((V, \rho)\) una representación de \(G\) e \(W \leq V\). Se \(W\) es \emph{\(G\)-inv} (esto es \(\rho_s(W) \subset W, \ \forall s \in G\)), entonces \(W\) es una \emph{sub-representación} de \(G\) vía: 
    \[\rho|_{_W}: G\ni s \mapsto \rho_s|_{_W} \in \GL(W).\]     
\end{definition}

\begin{theorem}
    \textbf{1.} Sean \((V,\rho)\) e \(W\leq V\) \(G\)-inv. Entonces, \(\exists W^0 \leq V\) \(G\)-inv \(: V = W \oplus W^0\). 
\end{theorem}
...
\begin{theorem}
    \textbf{2.} Toda representación es suma directa de representaciones irreducibles. \comentario{Mogollas, sigue por inducción en \(\dim V\) usando el \(\blacksquare\) \hyperlink{thm1}{1. }}
\end{theorem}
...
ambos subespacios son \(G\)-inv, llamados \emph{cuadrados simétrico} e \emph{alternado} de \((V, \rho)\).% de bases \(\alpha^2_{\leq}\) e \(\alpha^2_<\), respectivamente.