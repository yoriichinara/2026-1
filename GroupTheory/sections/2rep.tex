...
\begin{proposition}
    \textbf{4. (\emph{Lema de Schur})} Sean \((V_1, \rho^1)\) e \((V_2, \rho^2)\) irruducibles e \(f \in \hom(V_1, V_2) : f \circ \rho_s^1 = \rho^2_s \circ f, \ \forall s \in G\). Entonces, \(f\equiv 0\) (\(\rho^1 \nsim \rho^2 \))  o \(f = a\cdot \id : a \in \C\) (\(\rho^1 \sim \rho^2\)).  
\end{proposition}
